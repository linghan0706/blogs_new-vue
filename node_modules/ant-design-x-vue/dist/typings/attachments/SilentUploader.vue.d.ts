...
declare const _default: import("vue").DefineComponent<SilentUploaderProps, {
    nativeElement: Readonly<import("vue").ShallowRef<import("vue").CreateComponentPublicInstanceWithMixins<Readonly<import("vue").ExtractPropTypes<{
        ...
        height: unknown;
        data: Record<string, unknown> | ((file: import("ant-design-vue/es/upload/interface").UploadFile<any>) => Record<string, unknown> | Promise<Record<string, unknown>>);
        onDrop: (event: DragEvent) => void;
        onChange: (info: import("ant-design-vue/es/upload/interface").UploadChangeParam<import("ant-design-vue/es/upload/interface").UploadFile<any>>) => void;
        multiple: boolean;
        disabled: boolean;
        method: "post" | "POST" | "PUT" | "PATCH" | "put" | "patch";
        remove: (file: import("ant-design-vue/es/upload/interface").UploadFile<any>) => boolean | void | Promise<boolean | void>;
        ...
        onRemove: (file: import("ant-design-vue/es/upload/interface").UploadFile<any>) => boolean | void | Promise<boolean | void>;
        removeIcon: (opt: {
            file: import("ant-design-vue/es/upload/interface").UploadFile<any>;
        }) => import("ant-design-vue/es/_util/type").VueNode;
        ...
        'onUpdate:fileList': (fileList: import("ant-design-vue/es/upload/interface").UploadFile<any>[]) => void;
        listType: import("ant-design-vue/es/upload/interface").UploadListType;
        onPreview: (file: import("ant-design-vue/es/upload/interface").UploadFile<any>) => void;
        onDownload: (file: import("ant-design-vue/es/upload/interface").UploadFile<any>) => void;
        ...
        isImageUrl: (file: import("ant-design-vue/es/upload/interface").UploadFile<any>) => boolean;
        downloadIcon: (opt: {
            file: import("ant-design-vue/es/upload/interface").UploadFile<any>;
        }) => import("ant-design-vue/es/_util/type").VueNode;
        previewIcon: (opt: {
...
}, {}, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, {}, string, import("vue").PublicProps, Readonly<SilentUploaderProps> & Readonly<{}>, {}, {}, {}, {}, string, import("vue").ComponentProvideOptions, false, {}, any>;
